...
public:
	...
	void show_stats()
	{
		std::cout << "Number of planes served in the arrival queue: " << landing_queue->get_num_served() << "planes" << std::endl;
		std::cout << "Total wait time for all planes in arrival queue: " << landing_queue->get_total_wait() << "mins" << std::endl;
		std::cout << "Average wait time for the landing queue: " << landing_queue->get_total_wait() / landing_queue->get_num_served() << " min/plane" << std::endl;
		// FIXME: Calculate and display the average wait time for the landing queue
		

		std::cout << std::endl;
		std::cout << "Number of planes served in the departure queue: " << departure_queue->get_num_served() << " planes" << std::endl;
		std::cout << "Total wait time for all planes in departure queue: " << departure_queue->get_total_wait() << "mins" << std::endl;
		std::cout << "Average wait time for the departure queue: " << departure_queue->get_total_wait() / departure_queue->get_num_served() << " min/plane" << std::endl;
